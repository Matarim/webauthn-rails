module WebauthnRails
  class CredentialsController < ActionController::Base
    ...
    def create
      ...
      options = { username: user, verification: 'required' }

      create_options = WebauthnRails::Credentials.create_challenge(user, options)
